...
final class FulfilledPromise implements PromiseInterface {
	...
	public function __construct($value = null) {
		if($value instanceof PromiseInterface) {
			throw new InvalidArgumentException("You cannot create arkania\\utils\\promise\\internal\\FulfilledPromise with a promise. Use arkania\\utils\\promise\\resolve(\$promiseOrValue) instead.");
		}
		$this->value = $value;
	}
